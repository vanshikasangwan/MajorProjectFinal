...
const MainPage = () => {
  ...
  return (
    ...
    <div style={{ marginTop: '20px', fontSize:'20px', fontWeight: 'bolder', marginLeft:"750px" , color:"white"}}>
      ...
      <button type='button'  onClick= {NewMemoryGame} style={{marginLeft: '6px', color:'red', borderWidth:'medium', background:'pink',height:'40px',width:'90px',fontSize:'15px', borderRadius:'7px'}}> Play Now
    ...
    <div style={{ marginTop: '20px', fontSize:'20px', fontWeight: 'bolder', marginLeft:"750px" , color:"white" }}>
    Color Memory Game:  
      <button type='button'  onClick= {NewColourMemory} style={{marginLeft: '6px', color:'red', borderWidth:'medium', background:'pink',height:'40px',width:'90px',fontSize:'15px', borderRadius:'7px'}}> Play now
